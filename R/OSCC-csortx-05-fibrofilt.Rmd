...
source(paste0("~/tscr/kai/projects/01_SCC_scRNA/results/functions_220808.R"))
...
## low zoom level (zoom0)

```{r}
SCC.fibro$Celltype_fibro_zoom0 <- as.character(SCC.fibro$seurat_clusters_fibro_SCTccmito_PCA_harmony_res3)
SCC.fibro$Celltype_fibro_zoom0[SCC.fibro$seurat_clusters_fibro_SCTccmito_PCA_harmony_res15=="42"] <- "Myoblasts"
SCC.fibro$Celltype_fibro_zoom0[SCC.fibro$seurat_clusters_fibro_SCTccmito_PCA_harmony_res15=="60"] <- "Fibroblasts"
...
SCC.fibro$Celltype_fibro_zoom0[SCC.fibro$Celltype_fibro_zoom0=="3"] <- "Myofibroblasts"
