...
```{r}
SCC.B.temp <- SCC.B
SCC.B <- subset(SCC.B.temp,cells = names(SCC.B.temp$CellType_BCells[SCC.B.temp$CellType_BCells %in% c("B-Cells","Plasmablasts")])) 
rm(SCC.B.temp)
...
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-PCA.svg"),PCAplot.SCTccmito, width = 5, height = 5)
# without legends
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-PCA-noleg.svg"),PCAplot.SCTccmito + theme(legend.position = "none") + labs(title = NULL), width = 5, height = 5)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-PCA-elbow.svg"),PCAelbowplot.SCTccmito, width = 5, height = 5)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-PCA-elbow-noleg.svg"),PCAelbowplot.SCTccmito + theme(legend.position = "none") + labs(title = NULL), width = 5, height = 5)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-PCA-variancesum.svg"),PCAsumplot.SCTccmito, width = 5, height = 5)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-PCA-variancesum-noleg.svg"),PCAsumplot.SCTccmito + theme(legend.position = "none") + labs(title = NULL),width = 5, height = 5)
...
SCC.B$seurat_clusters_BCellsfilt_SCTccmito_PCA_harmony <- SCC.B$seurat_clusters
...
umapharmony.SCTccmito.clusPCAharmony <- DimPlot(SCC.B,
                                                ...
                                                pt.size = 1,
                                                label = T,
                                                group.by = "seurat_clusters_BCellsfilt_SCTccmito_PCA_harmony") +
  theme_jb_nogrid()
...
UMAPharmony.SCTccmito.qc <- FeaturePlot_markers_comb(SCC.B, c("nCount_RNA_log10", "nFeature_RNA_log10", "percent.mito", "n.exp.hkgenes","S.Score","G2M.Score"),"humap_SCTccmito")

ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-clusPCAharmony.svg"),umapharmony.SCTccmito.clusPCAharmony)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-clusPCAharmony-noleg.svg"),umapharmony.SCTccmito.clusPCAharmony + theme(legend.position = "none") + labs(title = NULL), width = 5, height = 5)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-patients.svg"),umapharmony.SCTccmito.patients)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-patients-noleg.svg"),umapharmony.SCTccmito.patients + theme(legend.position = "none") + labs(title = NULL), width = 5, height = 5)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-sample.svg"),umapharmony.SCTccmito.sample)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-sample-noleg.svg"),umapharmony.SCTccmito.sample + theme(legend.position = "none") + labs(title = NULL), width = 5, height = 5)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-Lok.svg"),umapharmony.SCTccmito.Lok)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-Lok-noleg.svg"),umapharmony.SCTccmito.Lok + theme(legend.position = "none") + labs(title = NULL), width = 5, height = 5)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-lib.svg"),umapharmony.SCTccmito.lib)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-lib-noleg.svg"),umapharmony.SCTccmito.lib + theme(legend.position = "none") + labs(title = NULL), width = 5, height = 5)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-Phase.svg"),umapharmony.SCTccmito.Phase)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-Phase-noleg.svg"),umapharmony.SCTccmito.Phase + theme(legend.position = "none") + labs(title = NULL), width = 5, height = 5)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-QC.svg"),UMAPharmony.SCTccmito.qc, width=10, height=10)
...
SCC.B$seurat_clusters_BCellsfilt_SCTccmito_PCA_harmony_res100 <- SCC.B$seurat_clusters
SCC.B$seurat_clusters <- NULL
...
umapharmony.SCTccmito.clusPCAharmonyres100 <- DimPlot(SCC.B,
                                                      ...
                                                      pt.size = 1,
                                                      label = F,
                                                      group.by = "seurat_clusters_BCellsfilt_SCTccmito_PCA_harmony_res100") + 
  labs(title=NULL) +
  theme_jb_nogrid() + 
  theme(legend.position = "none")

ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-clusPCAharmony-res100-noleg.png"),umapharmony.SCTccmito.clusPCAharmonyres100, width = 5, height = 5)
...
predclus.monaco <- SingleR(test = GetAssayData(SCC.B, slot = "data",assay = "SCTccmito"), 
                           ref = monaco.ref, 
                           assay.type.test = 1,
                           clusters = SCC.B$seurat_clusters_BCellsfilt_SCTccmito_PCA_harmony_res100,
...
SCC.B$SingleR.monaco.res100 <- cluslabels.monaco[match(SCC.B$seurat_clusters_BCellsfilt_SCTccmito_PCA_harmony_res100,names(cluslabels.monaco))]
...
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-SingleR-monaco_res100.svg"),UMAPharmony.SCTccmito.singleR_monaco_res100, width = 5, height = 5)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-SingleR-monaco_res100-noleg.svg"),UMAPharmony.SCTccmito.singleR_monaco_res100 + theme(legend.position = "none"), width = 5, height = 5)
ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-SingleR-monaco_res100-nolabelleg.svg"),UMAPharmony.SCTccmito.singleR_monaco_res100.nol + theme(legend.position = "none"), width = 5, height = 5)
...
for (type in unique(SCC.B$SingleR.monaco.res100)) {
  ...
  UMAPharmony.SCTccmito.singleR_monaco_res100.type[[type]] <- DimPlot(SCC.B, 
    ...
    ggtitle(type) +
    theme_jb_nogrid()
  ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-SingleR-monaco-res100-",gsub("-",".",gsub(" ",".",gsub("/",".",type))),"-noleg.png"),UMAPharmony.SCTccmito.singleR_monaco_res100.type[[type]] + theme(legend.position = "none"), width = 5, height = 5)
}
...
```{r}
SCC.B.clusharmony <- calculate_foldchanges(SCC.B,SCC.B$seurat_clusters_BCellsfilt_SCTccmito_PCA_harmony)
...
for (i in names(SCC.B.clusharmony.volpct)) {
  ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-diffexpr-SCTccmito-clusharmony-volcanopct-",gsub("[/]","",sub(" ","",sub("[)]","",sub("[(]","",i)))),".svg"),SCC.B.clusharmony.volpct[[i]])
}
for (i in names(SCC.B.clusharmony.volpctdiff)) {
  ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-diffexpr-SCTccmito-clusharmony-volcanopctdiff-",gsub("[/]","",sub(" ","",sub("[)]","",sub("[(]","",i)))),".svg"),SCC.B.clusharmony.volpctdiff[[i]])
}
...
lapply(names(GS.gsea.clusharmony.plot), function(x) try(ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-diffexpr-SCTccmito-clusharmony-GS-top",numberofGS,"byNES-",gsub("[/]","",sub(" ","",sub("[)]","",sub("[(]","",x)))),".svg"),GS.gseavis.clusharmony[[x]],width=10, height=5)))
...
try(ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-diffexpr-SCTccmito-clusharmony-GS-top",numberofGS,"byNES-all.svg"),
           plot_grid(plotlist = GS.gseavis.clusharmony.comb,ncol=1,align = "v",labels=NULL),
           width=10, 
           height=20))

try(ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-diffexpr-SCTccmito-clusharmony-GS-top",numberofGS,"byNES-all-noleg.svg"),
...
try(ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-diffexpr-SCTccmito-clusharmony-GS-top",numberofGS,"byNES-all-nolegaxis.svg"),
           plot_grid(plotlist = lapply(GS.gseavis.clusharmony.comb,function(x) x + theme(legend.position = "none")),ncol=1,align = "v",labels=NULL),
           width=10, 
           height=20))
```
...
expr.RNAscaledata.hl.clusharmony.hm <- Heatmap(expr.RNAscaledata.hl.clusharmony,
                                               ...
                                               column_split = SCC.B$seurat_clusters_BCellsfilt_SCTccmito_PCA_harmony,
                                               row_split = factor(highlightgenes.clusharmony$state, levels = levels(SCC.B$seurat_clusters_BCellsfilt_SCTccmito_PCA_harmony)),
                                               ...
                                               width = unit(10,"in"))
#Save Heatmap
pdf(paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-diffexpr-SCTccmito-clusharmony-HM-RNAscaledata-top",as.character(topgenes),".pdf"), width=20, height=30)
...
lapply(names(UMAPharmony.SCTccmito.marker), function(x) ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-marker-",x,".png"),UMAPharmony.SCTccmito.marker[[x]],dpi=300, width=ifelse(length(celltypemarkers[[x]])>1,10,5), height=5*ceiling(length(celltypemarkers[[x]])/2)))
...
```{r}
SCC.B$CellType_BCells2 <- as.character(SCC.B$seurat_clusters_BCellsfilt_SCTccmito_PCA_harmony)
SCC.B$CellType_BCells2[SCC.B$CellType_BCells2=="28"] <- "Fibroblasts"
SCC.B$CellType_BCells2[SCC.B$CellType_BCells2 %in% c("13","14","15","18","19","23","24")] <- "Plasmablasts"
SCC.B$CellType_BCells2[!SCC.B$CellType_BCells2=="Fibroblasts"] <- "B-Cells"

umapharmony.SCTccmito.celltypetcells <- DimPlot(SCC.B,
                                                reduction = "humap_SCTccmito",
                                                pt.size = 1,
                                                label = T,order=T,
                                                group.by = "CellType_BCells2") +
  theme_jb_nogrid()

ggsave(filename = paste0(OUTPUT,"figs/SCCfilt-BCellsfilt-SCTccmito-UMAPharmony-CelltypeBCells2-noleg.svg"),umapharmony.SCTccmito.celltypetcells + theme(legend.position = "none"), height=5, width = 5)
...
save(file = paste0(OUTPUT,"RData/SCCfilt-BCellsfilt.RData"),SCC.B)
#SessionInfo
writeLines(capture.output(sessionInfo()), paste0(OUTPUT,"RData/SCCfilt-BCellsfilt-sessionInfo.txt"))
```
