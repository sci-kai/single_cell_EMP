...
#split up al duplicated genes again. i.e., genes that are in at least two clusters. Put them in both!
uebertrag <- positivelogFCgenestype.final[positivelogFCgenestype.final$numberofstates==1,]
uebertrag$cluster <- as.character(uebertrag$cluster)
tosplit <- positivelogFCgenestype.final[positivelogFCgenestype.final$numberofstates>1,]
...
positivelogFCgenestype.final <- rbind(uebertrag,splitted)
positivelogFCgenestype.final$cluster <- factor(positivelogFCgenestype.final$cluster)
